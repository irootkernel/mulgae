...
D-030 through D-039 extend D-001 through D-029 and remain the frozen Revision 14 contract decisions. SOT 1.5.0 records that G001 completed Gate A, required provider/platform evidence, promotion, authority CAS, post-verification `g0_complete`, support derivation, and separate implementation approval.

G002 through G006 completed the domain/ports foundation, trusted adapters and foundation CLI, prompt/validation/fake-review slice, coordinator/runtime/evidence/axes boundary, and publication/recovery/reporting/query boundary. G007 completes authority-gated adapters and evidence reporting for exactly `kimi`, `zcode`, and `agy`; absence of injected authority remains `UNVERIFIED`. G008 completes the real composed P2 four-run-type, cleanup, and export application surface, including immutable lineage, runtime artifacts, retention-plan, and redacted-export ownership. G009 remains pending; its integrated release gate requires final review and test receipts completed and retained by the leader. G008 does not authorize release CI or release assets. The current SOT oracle remains 17 product commands, 4 canonical probe argv, 71 catalog paths, 70 checksummed payloads, 23 schema/example pairs, and 16 G0-required pairs. No unsupported tuple, release CI, or release asset is authorized by this completed boundary.
