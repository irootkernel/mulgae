...
| D-032 | Six functional roles are enabled by default; logic and security are the required floor | Superseded by D-045 | Retained as historical role-selection behavior |
...
| D-034 | Optional exhaustion may publish degraded valid content; required exhaustion is incomplete and preserves valid content | Superseded by D-045 | Retained as historical exhaustion behavior |
...
| D-041 | Reopen production review implementation | Superseded by D-059 | Retained as the historical G009/G010 reopening condition; current closure is governed by G011 |
...
| D-059 | `make test` remains the sole release gate, with deterministic product acceptance and one live capability certification per supported provider family | Accepted | Product semantics must not depend on stochastic findings, exact line claims, role consensus, or timing overlap. The live boundary still fails closed for missing binaries, native authentication, service access, or provider compatibility |
...
| Historical controlled Kimi qualification receipt | `kimi/local-default/0.23.6/50c3582a1beeba081271193b74efc39c51b3a0a16b4bf32b754b9482a86a314a/kimi-default`; receipt SHA-256 `1227711091fc94aff32dfed18d34f009da7404862b1eb63d99a2313a30c2be27`; raw-output SHA-256 `435639659d6ec453a8271d9a82787e11d4aa1be0450b981b0aab040966172141`; append-only external ledger is authoritative and development evidence is excluded from Git | PASS; diagnostic provenance, not an ordinary-use version or SHA-256 gate |
