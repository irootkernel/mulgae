...
func TestServiceResolvesSoleCanonicalLocalSource(t *testing.T) {
	...
	config := adapterconfig.Config{Version: 1, Project: adapterconfig.ProjectConfig{Name: "project"}, NativeUser: adapterconfig.NativeUserConfig{Home: "/Users/test"}, Providers: adapterconfig.ProvidersConfig{AGY: &adapterconfig.AGYProviderConfig{Executable: "/bin/agy", PermissionMode: "safe"}}, Execution: adapterconfig.ExecutionConfig{WorkspaceAccess: "none"}, Roles: adapterconfig.RolesConfig{Logic: adapterconfig.RoleConfig{Enabled: true}, Security: adapterconfig.RoleConfig{Enabled: true}, Maintainability: adapterconfig.RoleConfig{Enabled: true}, Product: adapterconfig.RoleConfig{Enabled: true}, Documentation: adapterconfig.RoleConfig{Enabled: true}, Testing: adapterconfig.RoleConfig{Enabled: true}}, Review: adapterconfig.ReviewConfig{RequiredRoles: []string{"logic", "security"}, RequestChangesOn: []string{"high", "critical", "blocker"}}, Validation: adapterconfig.ValidationConfig{Evidence: adapterconfig.EvidenceConfig{RequireVerifiedFor: []string{"high", "critical", "blocker"}}, Repair: adapterconfig.RepairConfig{Enabled: true, MaxAttempts: 1, SameProvider: true}}, Resources: adapterconfig.ResourcesConfig{MaxActiveLanes: 3, PrimaryRepairAttempts: 1, FallbackRepairAttempts: 1, RoleMaxInvocations: 2, RunMaxInvocations: 12, RunTotalOutputCap: "64MiB"}, CI: adapterconfig.CIConfig{FailOnSeverity: []string{"high", "critical", "blocker"}, DegradedReviewFails: true}}
