...
func validProjection() VerifiedSourceProjection {
	return VerifiedSourceProjection{
		...
		SchemaVersions: []string{"mulgae-review-artifact.v1", "mulgae-run-manifest.v1"}, Review: Review{SchemaVersion: "mulgae-review-artifact.v1", ContentVerdict: string(domain.ContentRequestChanges)}, Run: Run{SchemaVersion: "mulgae-run-manifest.v1", State: "completed"},
