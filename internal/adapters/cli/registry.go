// Package cli exposes the fixed G003 command registry and its dispatcher.
package cli
...
func canonicalCommandSpecs() []CommandSpec {
	return []CommandSpec{
		...
		newCommandSpec(app.CommandStatus, AvailabilityFutureMilestone, "internal/app/query", "ReadRunStatus", []string{runManifestContractURI, commandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact}),
		newCommandSpec(app.CommandReport, AvailabilityFutureMilestone, "internal/app/report", "RenderReport", []string{commandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact}),
		newCommandSpec(app.CommandFindings, AvailabilityFutureMilestone, "internal/app/query", "ListFindings", []string{reviewArtifactContractURI, commandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact}),
		newCommandSpec(app.CommandExcerpt, AvailabilityFutureMilestone, "internal/app/query", "RenderExcerpt", []string{commandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact}),
		newCommandSpec(app.CommandProviders, AvailabilityFutureMilestone, "internal/app/providers", "ListProviderProfiles", []string{providerContractEvidenceContractURI, commandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity}),
