...
const testCommandResultContractURI = "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json"
...
func TestCommandSpecsMatchCompleteSOTContract(t *testing.T) {
	want := []struct {
		...
		{app.CommandInit, "internal/app/init", "InitializeProject", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/init", []string{testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandDoctor, "internal/app/doctor", "DiagnoseEnvironment", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/doctor", []string{"https://mulgae.local/schemas/mulgae-doctor-result.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation}},
		{app.CommandReview, "internal/app/review", "StartReviewRun", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/review", []string{"https://mulgae.local/schemas/mulgae-run-manifest.v1.schema.json", "https://mulgae.local/schemas/mulgae-review-artifact.v1.schema.json", "https://mulgae.local/schemas/mulgae-review-preflight.v2.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodePolicy, app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandFollowup, "internal/app/followup", "StartFollowupRun", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/followup", []string{"https://mulgae.local/schemas/mulgae-provider-followup-output.v1.schema.json", "https://mulgae.local/schemas/mulgae-run-manifest.v1.schema.json", "https://mulgae.local/schemas/mulgae-review-artifact.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodePolicy, app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandDelta, "internal/app/delta", "StartDeltaRun", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/delta", []string{"https://mulgae.local/schemas/mulgae-run-manifest.v1.schema.json", "https://mulgae.local/schemas/mulgae-review-artifact.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodePolicy, app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandRerun, "internal/app/rerun", "StartRerun", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/rerun", []string{"https://mulgae.local/schemas/mulgae-run-manifest.v1.schema.json", "https://mulgae.local/schemas/mulgae-review-artifact.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodePolicy, app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandStatus, "internal/app/query", "ReadRunStatus", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/status", []string{"https://mulgae.local/schemas/mulgae-run-manifest.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandReport, "internal/app/report", "RenderReport", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/report", []string{testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandFindings, "internal/app/query", "ListFindings", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/findings", []string{"https://mulgae.local/schemas/mulgae-review-artifact.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandExcerpt, "internal/app/query", "RenderExcerpt", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/excerpt", []string{testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandProviders, "internal/app/providers", "ListProviderProfiles", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/providers", []string{"https://mulgae.local/schemas/mulgae-provider-contract-evidence.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity}},
		{app.CommandRoles, "internal/app/roles", "ListRoles", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/roles", []string{testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage}},
		{app.CommandConfig, "internal/app/config", "ResolveConfiguration", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/config", []string{"https://mulgae.local/schemas/mulgae-run-manifest.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandSchema, "internal/app/schema", "InspectSchema", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/schema", []string{testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact}},
		{app.CommandClean, "internal/app/clean", "CleanRuns", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/clean", []string{"https://mulgae.local/schemas/mulgae-clean-plan.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact, app.ExitCodeSecurity}},
		{app.CommandExport, "internal/app/export", "ExportRedactedRun", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/export", []string{"https://mulgae.local/schemas/mulgae-export-manifest.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact, app.ExitCodeSecurity}},
		{app.CommandHelp, "internal/app/help", "RenderHelp", "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json#/$defs/requests/help", []string{testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage}},
	}
