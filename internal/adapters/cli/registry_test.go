...
func TestCommandSpecsMatchCompleteSOTContract(t *testing.T) {
	want := []struct {
		...
		{app.CommandDoctor, "internal/app/doctor", "DiagnoseEnvironment", "https://mulgae.local/schemas/mulgae-command-result.v1.schema.json#/$defs/requests/doctor", []string{"https://mulgae.local/schemas/mulgae-doctor-result.v2.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation}},
		{app.CommandReview, "internal/app/review", "StartReviewRun", "https://mulgae.local/schemas/mulgae-command-result.v1.schema.json#/$defs/requests/review", []string{"https://mulgae.local/schemas/mulgae-run-manifest.v2.schema.json", "https://mulgae.local/schemas/mulgae-review-artifact.v3.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodePolicy, app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		{app.CommandFollowup, "internal/app/followup", "StartFollowupRun", "https://mulgae.local/schemas/mulgae-command-result.v1.schema.json#/$defs/requests/followup", []string{"https://mulgae.local/schemas/mulgae-provider-followup-output.v2.schema.json", "https://mulgae.local/schemas/mulgae-run-manifest.v2.schema.json", "https://mulgae.local/schemas/mulgae-review-artifact.v3.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodePolicy, app.ExitCodeUsage, app.ExitCodeReadiness, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
		...
		{app.CommandFindings, "internal/app/query", "ListFindings", "https://mulgae.local/schemas/mulgae-command-result.v1.schema.json#/$defs/requests/findings", []string{"https://mulgae.local/schemas/mulgae-review-artifact.v3.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact, app.ExitCodeSecurity, app.ExitCodeCancellation, app.ExitCodeInternal}},
