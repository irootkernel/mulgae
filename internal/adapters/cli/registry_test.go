...
func TestCommandSpecsMatchCompleteSOTContract(t *testing.T) {
	want := []struct {
		...
		{app.CommandClean, "internal/app/clean", "PlanAndApplyRetention", "https://mulgae.local/schemas/mulgae-command-result.v1.schema.json#/$defs/requests/clean", []string{"https://mulgae.local/schemas/mulgae-clean-plan.v1.schema.json", testCommandResultContractURI}, []app.ExitCode{app.ExitCodeUsage, app.ExitCodeArtifact, app.ExitCodeSecurity}},
