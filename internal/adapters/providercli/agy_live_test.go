...
func TestLiveAgyCurrentBehavior(t *testing.T) {
	...
	if err != nil {
		t.Fatal("INCONCLUSIVE: installed AGY current probe failed")
	}
...
func TestLiveAgyInstalledHomeRejectsOverrideMismatch(t *testing.T) {
...
func TestLiveAgyNamespaceRejectsCopiedNativeSettings(t *testing.T) {
	root := t.TempDir()
...
func TestLiveAgyAuthSettingsManifestDetectsMutation(t *testing.T) {
	home := t.TempDir()
