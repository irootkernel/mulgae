...
import "github.com/irootkernel/kkachi-agent-review/internal/ports"
...
const (
	providerContractEvidenceV2ID = "https://kar.local/schemas/kar-provider-contract-evidence.v2.schema.json"
	platformContractEvidenceV2ID = "https://kar.local/schemas/kar-platform-contract-evidence.v2.schema.json"
)
