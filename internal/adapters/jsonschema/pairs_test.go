...
func TestInitMutationEnvelopeRequiresExactOutcomeTuple(t *testing.T) {
	...
	schemaID := mustAssetID(t, "https://mulgae.local/schemas/mulgae-command-result.v2.schema.json")
...
var authoritativePairs = []schemaExamplePair{
	...
	{"https://mulgae.local/schemas/mulgae-command-result.v2.schema.json", "example:command-result.v2.valid.json"},
	...
	{"https://mulgae.local/schemas/mulgae-review-preflight.v2.schema.json", "example:review-preflight.v2.valid.json"},
...
func TestBuildPairsRejectsPairPathThatDisagreesWithSchemaID(t *testing.T) {
	...
	mutated := bytes.Replace(
		...
		[]byte(`"pair": "sot/schemas/mulgae-command-result.v2.schema.json"`),
		1,
	)
...
func TestBuildPairsRejectsDuplicateExampleTarget(t *testing.T) {
	...
	mutated := bytes.Replace(
		g0.raw,
		[]byte(`"path": "sot/examples/command-result.v2.valid.json"`),
...
func TestBuildPairsRejectsReverseAndCardinalityViolations(t *testing.T) {
	...
	commandPair := []byte(`"pair": "sot/examples/command-result.v2.valid.json"`)
