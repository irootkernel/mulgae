...
- [x] Execute the exact release Mulgae binary against actual Kimi, ZCode, and AGY through Config v2 init/config/doctor, six-role root review, schema-valid P2 publication, diagnostics, cleanup, followup, delta, exact rerun, and recomposed rerun. Evidence: `TestE2EActualProvidersProductionWorkflow` passed through the Makefile-built v1.14 candidate in 1042.036 seconds with all six initial primary assignments and all four child workflows.
