...
| D-047 | Config v1 explicitly owns each role's primary and fallback family | Accepted | Removes ambiguous planner-selected family preference while retaining qualification and lane authority in Mulgae |
